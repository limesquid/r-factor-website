  ...
  actions: (
    <React.Fragment>
      ...
      <ul className="text-muted">
        ...
        <li>Moves static <code>propTypes</code> declaration below the component definition (if present)</li>
        <li>Moves static <code>defaultProps</code> declaration below the component definition (if present)</li>
